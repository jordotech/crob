...
var m = {
    "images": [
        ...
        {
            "thumb":"./media/THUMBS/Beck_05.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_06.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_07.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_08.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_09.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_10.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_11.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_12.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_13.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_14.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_15.jpg",
    ...
    "stills": [
        ...
        {
            "thumb":"./media/THUMBS/Beck_20.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_21.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_22.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_23.jpg",
        ...
        {
            "thumb":"./media/THUMBS/Beck_24.jpg",
...
animateApp.config(function ($routeProvider) {
    $routeProvider
        ...
        .when('/images', {
            templateUrl: 'templates/page-images.html',
            controller: 'imagesController'
        })
        .when('/stills', {
            templateUrl: 'templates/page-stills.html',
